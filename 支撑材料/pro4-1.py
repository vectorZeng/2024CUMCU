...
cases = [
    {'零配件1次品率': 0.096, '零配件2次品率': 0.1065, '成品次品率': 0.0924, '零配件1检测成本': 2, '零配件2检测成本': 3,
     '零配件1购买单价': 4, '零配件2购买单价': 18, '成品检测成本': 3, '装配成本': 6, '市场售价': 56, '调换损失': 6, '拆解费用': 5},
    {'零配件1次品率': 0.1667, '零配件2次品率': 0.1962, '成品次品率': 0.223, '零配件1检测成本': 2, '零配件2检测成本': 3,
     '零配件1购买单价': 4, '零配件2购买单价': 18, '成品检测成本': 3, '装配成本': 6, '市场售价': 56, '调换损失': 6, '拆解费用': 5},
    {'零配件1次品率': 0.0873, '零配件2次品率': 0.112, '成品次品率': 0.1242, '零配件1检测成本': 2, '零配件2检测成本': 3,
     '零配件1购买单价': 4, '零配件2购买单价': 18, '成品检测成本': 3, '装配成本': 6, '市场售价': 56, '调换损失': 30, '拆解费用': 5},
    {'零配件1次品率': 0.2143, '零配件2次品率': 0.2171, '成品次品率': 0.1943, '零配件1检测成本': 1, '零配件2检测成本': 1,
     '零配件1购买单价': 4, '零配件2购买单价': 18, '成品检测成本': 2, '装配成本': 6, '市场售价': 56, '调换损失': 30, '拆解费用': 5},
    {'零配件1次品率': 0.0972, '零配件2次品率': 0.1736, '成品次品率': 0.1042, '零配件1检测成本': 8, '零配件2检测成本': 1,
     '零配件1购买单价': 4, '零配件2购买单价': 18, '成品检测成本': 2, '装配成本': 6, '市场售价': 56, '调换损失': 10, '拆解费用': 5},
    {'零配件1次品率': 0.0573, '零配件2次品率': 0.0620, '成品次品率': 0.0327, '零配件1检测成本': 2, '零配件2检测成本': 3,
...
def total_profit_cal(case, n, BUY, detect_parts1, detect_parts2, detect_final, dismantle):
    ...
    return total_cost, total_gain, total_profit
...
plt.grid(True)
# 保存图形为 .eps 文件
plt.savefig("pics/问题四：不同决策方案在不同情况下的总利润曲线.eps", format='eps')
plt.savefig("pics/问题四：不同决策方案在不同情况下的总利润曲线.png", format='png')
plt.show()
...
#%%
    ...
    plt.savefig("pics/问题四：不同决策方案在情况1下的总利润直方图.eps", format='eps')
    plt.savefig("pics/问题四：不同决策方案在情况1下的总利润直方图.png", format='png')
    # 显示图形
    plt.show()
...
#%%
    ...
    plt.savefig("pics/问题四：不同决策方案在情况3下的总利润直方图.eps", format='eps')
    plt.savefig("pics/问题四：不同决策方案在情况3下的总利润直方图.png", format='png')
    # 显示图形
    plt.show()
